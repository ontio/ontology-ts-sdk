...
import { buildRestfulParam, buildRpcParam, buildTxParam, Default_params, makeDeployCodeTransaction, makeInvokeTransaction, parseEventNotify, sendRawTxRestfulUrl, signTransaction } from '../src/transaction/transactionBuilder';
...
const testDeployCodeTx = (code, vmType = VmType.NEOVM) => {
    ...
    const tx = makeDeployCodeTransaction(code, vmType, 'name', '1.0', 'alice', 'testmail', 'desc', true, '0');
