...
import { Default_params, parseEventNotify, makeInvokeTransaction, signTransaction, makeDeployCodeTransaction, buildTxParam, buildRestfulParam, buildRpcParam, sendRawTxRestfulUrl} from '../src/transaction/transactionBuilder'
...
var privateKey = new PrivateKey('7c47df9664e7db85c1308c080f398400cb24283f5d922e76b478b5429e821b93')
var account = new Account()
account.create(privateKey, '123456', 'test')
...
const testDeployCodeTx = (code, vmType = VmType.NEOVM) => {
    ...
    var tx = makeDeployCodeTransaction(code, vmType, 'name', '1.0','alice', 'testmail','desc',true, '0')
