...
describe("test websocket", () => {
  ...
  const adminPrivateKey = new PrivateKey(
    "7c47df9664e7db85c1308c080f398400cb24283f5d922e76b478b5429e821b97"
  );
  ...
  test.skip("test_getMempoolTxState", async () => {
    ...
    const result = await client.getMempoolTxState(
      "6f3c0da62e83c126c7e3b2381d5fd6d2513026afcabea295f0a8dd8bcca2a7ad"
    );
  ...
  test.skip("test getStorage", async () => {
    const key =
      "2a6469643a6f6e743a5443375a6b556a62694e36794b61415433687735567a714c713138587538635a4a5702";
